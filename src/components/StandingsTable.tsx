        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-muted/30 border-b border-border/50">
              <th className="text-left py-3 px-3 font-display text-xs text-muted-foreground uppercase tracking-wider">#</th>
          ...
          <tbody>
            ...
            {teamList.length === 0 && <tr><td colSpan={compact ? 8 : 11} className="text-center py-8 text-muted-foreground">Nenhuma equipa registada.</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
